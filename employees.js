...
class Employee {
    constructor(named, shifts){
        this.named = named;
        this.shifts = shifts;
    }
    getSchedule(){
        console.log(`${this.named} works on ${this.shifts}`)
    }
}
...
class Manager extends Employee {
    constructor(employees, named, shifts){
    super(named, shifts)
    this.employees = employees
    }
    getEmployees(){
        console.log(`${this.named} manages ${this.employees}`)
    }
    addEmployee(emp){
...
//CODE HERE
let manager = new Manager('Cece and Schmidt', 'Winston', 'weekday mornings, weekday afternoons')
