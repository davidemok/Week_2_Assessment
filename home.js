...
//CODE HERE
let newDeal = deals.replace(deals[0].title, "10% off!");
console.log(newDeal)
//i have no idea why it doesn't recognize replace
...
let newMonth = deals.replace(deals[1].desc, "This deal lasts until the end of April!")
